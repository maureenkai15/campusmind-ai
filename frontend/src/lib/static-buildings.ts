...
export const NTU_BUILDINGS: Building[] = [
  ...
  // ── Named Halls (Nanyang Crescent – RE@NTU) ───────────────────────────────
  { id: 61, code: "CRES",   name: "Crescent Hall",  short_name: "Crescent Hall", category: "residence", latitude: 1.35040, longitude: 103.67990, description: "One of the first RE@NTU named halls, opened 2014. Located along Nanyang Crescent with air-conditioned and non-AC rooms." },
  { id: 62, code: "PION",   name: "Pioneer Hall",   short_name: "Pioneer Hall",  category: "residence", latitude: 1.35070, longitude: 103.67970, description: "Opened 2014 alongside Crescent Hall. Houses CN Yang Scholars, NTU-USP, and LKCMedicine MBBS students." },
  { id: 63, code: "BINJ",   name: "Binjai Hall",    short_name: "Binjai Hall",   category: "residence", latitude: 1.35140, longitude: 103.67990, description: "Opened 2016. Located on Nanyang Avenue. Houses REP, TAISP, and NGL programme students." },
  { id: 64, code: "TANJ",   name: "Tanjong Hall",   short_name: "Tanjong Hall",  category: "residence", latitude: 1.34970, longitude: 103.68020, description: "Opened 2016 along Nanyang Crescent. Houses REP, TAISP, and NGL programme students." },
  { id: 65, code: "BANY",   name: "Banyan Hall",    short_name: "Banyan Hall",   category: "residence", latitude: 1.35000, longitude: 103.68010, description: "Opened 2016. Named after the banyan tree. Part of the Nanyang Crescent cluster of RE@NTU halls." },
  { id: 66, code: "SARA",   name: "Saraca Hall",    short_name: "Saraca Hall",   category: "residence", latitude: 1.35020, longitude: 103.68060, description: "Opened 2017. Named after the Saraca tree. Features attached and common toilets, mixed air-conditioning." },
  { id: 67, code: "TAMA",   name: "Tamarind Hall",  short_name: "Tamarind Hall", category: "residence", latitude: 1.35060, longitude: 103.68040, description: "Opened 2017. Named after the tamarind tree. Part of the Phase 2 RE@NTU expansion along Nanyang Crescent." },

  // ── Medical & Wellness ────────────────────────────────────────────────────
  { id: 68, code: "HLTH",   name: "Campus Health & Medical Centre",      short_name: "Health Centre",   category: "medical",   latitude: 1.34770, longitude: 103.68220, description: "NTU's on-campus clinic offering GP consultations, vaccinations, and mental health support. Near North Spine." },
  { id: 69, code: "MFSC",   name: "Multi-Faith Spiritual Centre",        short_name: "MFSC",            category: "admin",     latitude: 1.34760, longitude: 103.68230, description: "Quiet multi-faith centre for prayer and spiritual reflection, open to all religions." },

  // ── Transport & Access ─────────────────────────────────────────────────────
  { id: 70, code: "BUS-N",  name: "North Bus Terminal",                  short_name: "North Bus Term.",  category: "transport", latitude: 1.34950, longitude: 103.68350, description: "Main north campus bus terminus. Shuttle routes A, B, C depart here. NTU Campus Rider app shows live arrivals." },
  { id: 71, code: "BUS-S",  name: "South Bus Terminal",                  short_name: "South Bus Term.",  category: "transport", latitude: 1.34100, longitude: 103.68250, description: "South campus shuttle stop. Route C & D services. Near South Spine." },
  { id: 72, code: "BUS-NH", name: "North Hill Bus Stop",                 short_name: "North Hill Bus",   category: "transport", latitude: 1.34980, longitude: 103.67950, description: "Bus stop serving the halls area. Routes A and D stop here." },
  { id: 73, code: "BUS-NIE",name: "NIE Bus Stop",                        short_name: "NIE Bus",          category: "transport", latitude: 1.34900, longitude: 103.68900, description: "Dedicated bus stop outside NIE. Routes B and C stop here." },
  { id: 74, code: "BUS-ADM",name: "ADM Bus Stop",                        short_name: "ADM Bus",          category: "transport", latitude: 1.34800, longitude: 103.67950, description: "Bus stop near the School of Art, Design & Media. Route A." },
  { id: 75, code: "CARPARK",name: "Pioneer Car Park (Visitor Parking)",  short_name: "Visitor Parking",  category: "transport", latitude: 1.35000, longitude: 103.68020, description: "Main visitor car park. Season parking available for students with vehicles." },

  // ── Admin & Other Facilities ──────────────────────────────────────────────
  { id: 76, code: "ADM-BLK",name: "Administration Building",             short_name: "Admin Block",      category: "admin",     latitude: 1.34830, longitude: 103.68320, description: "NTU's administrative offices, Registrar's Office, and student affairs. Near North Spine." },
  { id: 77, code: "GSSR",   name: "Graduate Students' Resource Room",    short_name: "Grad. Students",   category: "admin",     latitude: 1.34840, longitude: 103.68300, description: "Resource room with printing, lockers, and a rest area for graduate students." },
  { id: 78, code: "COOP",   name: "NTU Co-op Bookstore",                 short_name: "Co-op",            category: "admin",     latitude: 1.34120, longitude: 103.68160, description: "Official NTU bookstore at South Spine selling textbooks, stationery, NTU merchandise, and electronics." },
  { id: 79, code: "ATM-N",  name: "ATM Cluster (North Spine)",           short_name: "ATM North",        category: "admin",     latitude: 1.34840, longitude: 103.68340, description: "DBS, OCBC, and UOB ATMs clustered near North Spine Plaza." },
  { id: 80, code: "ATM-S",  name: "ATM Cluster (South Spine)",           short_name: "ATM South",        category: "admin",     latitude: 1.34130, longitude: 103.68170, description: "ATMs at South Spine near the Co-op store." },
  { id: 81, code: "NTUONE", name: "NTU One-Stop Student Service Centre", short_name: "One-Stop Centre",  category: "admin",     latitude: 1.34860, longitude: 103.68310, description: "Central hub for student services: bursaries, accommodation applications, academic matters, and student IDs." },
];
