...
export const NTU_BUILDINGS: Building[] = [
  ...
  { id: 63, code: "RCBIN",  name: "Binjai Hall (Residential College)",   short_name: "Binjai RC",       category: "residence", latitude: 1.35150, longitude: 103.68000, description: "Binjai Hall RC focusing on innovation, technology, and community service." },
  { id: 64, code: "RCTAN",  name: "Tanjong Hall (Residential College)",  short_name: "Tanjong RC",      category: "residence", latitude: 1.34980, longitude: 103.68030, description: "Tanjong Hall RC with vibrant arts culture and service-learning programmes." },
  { id: 65, code: "RCPALM", name: "Palm Villa (Residential College)",    short_name: "Palm Villa RC",   category: "residence", latitude: 1.35000, longitude: 103.68080, description: "Palm Villa RC emphasising global citizenship and interdisciplinary education." },
